...
// Endpoints
export const DATABASE_URL: string = process.env.DATABASE_URL || "https://database_container:3000";
export const USERMANAGEMENT_URL: string = process.env.USERMANAGEMENT_URL || "https://user_container:3000";
export const GAMESERVER_URL: string = process.env.GAMESERVER_URL || "https://gameserver_container:3000";
